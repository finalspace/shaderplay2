    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 node_6829 = _Time + _TimeEditor;
                float2 node_2685 = (i.uv0+node_6829.g*float2(0.05,0.05));
                ...
                float2 node_528 = (i.uv0+node_6829.g*float2(0.02,0.02));
...
////// Lighting:
////// Emissive:
                float2 node_6120 = (i.uv0+node_6829.g*float2(-0.05,-0.05));
                ...
                float2 node_8310 = (i.uv0+node_6829.g*float2(0.01,0.01));
                ...
                float3 emissive = (_OverallBrightness*((((_CausticBrightness+((_Shimmer_var.r-(1.0 - _Thickness))*_Opacity))*node_5586*pow(node_5586,_DepthPower))+(_Color.rgb*lerp(_ColorFar.rgb,_ColorNear.rgb,node_5586))+(lerp(_node_2255.rgb,_node_2766.rgb,pow(node_5586,_RimRange))*_RimColor.rgb*_RimPower)+lerp((node_7499_if_leA*node_717)+(node_7499_if_leB*float4(0,0,0,1)),node_717,node_7499_if_leA*node_7499_if_leB))*node_2440)).rgb;
