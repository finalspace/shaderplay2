...
Shader "Shader Forge/LakeShader" {
    Properties {
        ...
        _WavePower ("WavePower", Range(0, 1)) = 0.2077011
        ...
        _DistortionWave ("DistortionWave", Range(0, 2)) = 1
        _ReflectionNoiseTex ("ReflectionNoiseTex", 2D) = "white" {}
        _ReflectionRange ("ReflectionRange", Range(0, 1)) = 0.8446622
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 node_1671 = _Time + _TimeEditor;
                float2 node_2685 = (i.uv0+node_1671.g*float2(0.1,0.1));
                ...
                float2 node_528 = (i.uv0+node_1671.g*float2(0.02,0.02));
...
////// Lighting:
////// Emissive:
                float2 node_6120 = (i.uv0+node_1671.g*float2(-0.05,-0.05));
                ...
                float2 node_8310 = (i.uv0+node_1671.g*float2(0.02,0.02));
