    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float3 node_1714 = ((_node_6629_var.rgb-(1.0 - _Thickness))*_Opacity);
                float3 node_4073 = (_MainTex_var.a*_Color.a*node_1714);
                clip(node_4073 - 0.5);
////// Lighting:
////// Emissive:
