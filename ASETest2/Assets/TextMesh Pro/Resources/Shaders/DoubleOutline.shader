...
Shader "TextMeshPro/Mobile/Distance Field Double Outline" {
    ...
    Tags
  {
    ...
    Pass {
        ...
        pixel_t VertShader(vertex_t input)
        {
            ...
            float outline2 = _OutlineWidth2 * _ScaleRatioA * 0.5 * scale;
            ...
            pixel_t output = {
                ...
                half4(layerScale, layerBias, layerBias - outline2, layerBias + outline2),
            #endif
            };
        ...
        fixed4 PixShader(pixel_t input) : SV_Target
        {
            ...
            half4 underlayColor = float4(_UnderlayColor.rgb * _UnderlayColor.a, _UnderlayColor.a) * saturate(d_underlay - input.underlayParam.y) * (1 - c.a);
